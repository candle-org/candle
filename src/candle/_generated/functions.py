...
class LerpBackward0(Node):
    ...
    def _save(self, *, input_=None, other=None):
        tensors = []
        if input_ is not None:
            self._saved_input_idx = len(tensors)
            tensors.append(input_)
    ...
    def backward(self, grad):
        ...
        weight = self._weight
        with _grad_context(keyset):
            grad_input, grad_other = _lerp_backward_all(grad, input_, other, weight, keyset)
...
class AddcmulBackward0(Node):
    ...
    def _save(self, *, input_=None, tensor1=None, tensor2=None):
        tensors = []
        if input_ is not None:
            self._saved_input_idx = len(tensors)
            tensors.append(input_)
    ...
    def backward(self, grad):
        ...
        value = self._value
        with _grad_context(keyset):
            grad_input, grad_tensor1, grad_tensor2 = _addcmul_backward_all(grad, input_, tensor1, tensor2, value, keyset)
        return (grad_input, grad_tensor1, grad_tensor2,)
...
class AddcdivBackward0(Node):
    ...
    def backward(self, grad):
        ...
        value = self._value
        with _grad_context(keyset):
            grad_input, grad_tensor1, grad_tensor2 = _addcdiv_backward_all(grad, input_, tensor1, tensor2, value, keyset)
        return (grad_input, grad_tensor1, grad_tensor2,)
...
class AddmmBackward0(Node):
    ...
    def _save(self, *, input_=None, mat1=None, mat2=None):
        tensors = []
        if input_ is not None:
            self._saved_input_idx = len(tensors)
            tensors.append(input_)
    ...
    def backward(self, grad):
        ...
        alpha = self._alpha
        with _grad_context(keyset):
            grad_input, grad_mat1, grad_mat2 = _addmm_backward_all(grad, input_, mat1, mat2, beta, alpha, keyset)
...
class BaddbmmBackward0(Node):
    ...
    def _save(self, *, batch1=None, batch2=None, input_=None):
        tensors = []
    ...
    def backward(self, grad):
        ...
        alpha = self._alpha
        with _grad_context(keyset):
            grad_input, grad_batch1, grad_batch2 = _baddbmm_backward_all(grad, input_, batch1, batch2, beta, alpha, keyset)
...
class EmbeddingBackward0(Node):
    ...
    def backward(self, grad):
        ...
        sparse = self._sparse
        with _grad_context(keyset):
            grad_input = _embedding_backward_helper(grad, input_, weight, padding_idx, scale_grad_by_freq, keyset)
        return (grad_input,)
...
class CrossBackward0(Node):
    ...
    def backward(self, grad):
        ...
        dim = self._dim
        with _grad_context(keyset):
            grad_input, grad_other = _cross_backward_all(grad, input_, other, dim, keyset)
        return (grad_input, grad_other,)
...
class MinBackward0(Node):
    ...
    def backward(self, grad):
        ...
        other = _saved[self._saved_other_idx]
        with _grad_context(keyset):
            grad_input, grad_other = _min_backward_all(grad, input_, other, keyset)
        return (grad_input, grad_other,)
...
class MaxBackward0(Node):
    ...
    def backward(self, grad):
        ...
        other = _saved[self._saved_other_idx]
        with _grad_context(keyset):
            grad_input, grad_other = _max_backward_all(grad, input_, other, keyset)
        return (grad_input, grad_other,)
...
class Masked_selectBackward0(Node):
    ...
    def backward(self, grad):
        ...
        mask = _saved[self._saved_mask_idx]
        with _grad_context(keyset):
            grad_input = _masked_select_backward_helper(grad, input_, mask, keyset)
        return (grad_input,)
...
class TensordotBackward0(Node):
    ...
    def backward(self, grad):
        ...
        dims = self._dims
        with _grad_context(keyset):
            grad_input, grad_other = _tensordot_backward_all(grad, input_, other, dims, keyset)
        return (grad_input, grad_other,)
...
class Grid_sampleBackward0(Node):
    ...
    def backward(self, grad):
        ...
        align_corners = self._align_corners
        with _grad_context(keyset):
            grad_input, grad_grid = _grid_sample_backward_all(grad, input_, grid, mode, padding_mode, align_corners, keyset)
...
class RreluBackward0(Node):
    def __init__(self, inputs, *, raw_keyset=None, active_keyset=None):
        super().__init__(None, inputs, name='RreluBackward0')
        self._raw_keyset = raw_keyset
        self._active_keyset = active_keyset
        self._saved_input_idx = None
        self._saved_result_idx = None
    ...
    def backward(self, grad):
        ...
        training = self._training
        with _grad_context(keyset):
            grad_input = _rrelu_backward_helper(grad, input_, result, lower, upper, training, keyset)
        return (grad_input,)
...
class Ctc_lossBackward0(Node):
    ...
    def backward(self, grad):
        ...
        with _grad_context(keyset):
            grad_log_probs = _ctc_loss_backward_helper(grad, log_probs, targets, input_lengths, target_lengths, blank, reduction, zero_infinity, keyset)
...
class DistBackward0(Node):
    ...
    def backward(self, grad):
        ...
        p = self._p
        with _grad_context(keyset):
            grad_input, grad_other = _dist_backward_all(grad, input_, other, p, keyset)
        return (grad_input, grad_other,)
...
class Special_polygammaBackward0(Node):
    ...
    def backward(self, grad):
        ...
        n = self._n
        with _grad_context(keyset):
            grad_input = _special_polygamma_backward_helper(grad, n, input_, keyset)
        return (grad_input,)
...
class Special_multigammalnBackward0(Node):
    ...
    def backward(self, grad):
        ...
        p = self._p
        with _grad_context(keyset):
            grad_input = _special_multigammaln_backward_helper(grad, input_, p, keyset)
        return (grad_input,)
