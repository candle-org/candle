...
try:
    from .._C._dispatcher_core import cy_dispatch_full as dispatch  # noqa: F811
    from .._C._dispatcher_core import cy_dispatch_with_keyset_fast as dispatch_with_keyset  # noqa: F811
except ImportError:
    pass  # keep existing Python versions
