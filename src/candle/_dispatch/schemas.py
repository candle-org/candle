...
def register_schemas():
    ...
    registry.register_schema("zeros_like", "zeros_like(Tensor input, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None) -> Tensor")
    registry.register_schema("ones_like", "ones_like(Tensor input, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None) -> Tensor")
    registry.register_schema("empty_like", "empty_like(Tensor input, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None) -> Tensor")
    registry.register_schema("full_like", "full_like(Tensor input, Scalar fill_value, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None) -> Tensor")
    registry.register_schema("randn_like", "randn_like(Tensor input, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None, Generator? generator=None) -> Tensor")
    registry.register_schema("rand_like", "rand_like(Tensor input, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None, Generator? generator=None) -> Tensor")
    registry.register_schema("randint_like", "randint_like(Tensor input, int low=0, int? high=None, *, Dtype? dtype=None, Device? device=None, MemoryFormat? memory_format=None) -> Tensor")
    ...
    registry.register_schema("adaptive_max_pool3d", "adaptive_max_pool3d(Tensor input, Any output_size, bool return_indices=False) -> Tensor")
    ...
    registry.register_schema("max_unpool3d", "max_unpool3d(Tensor input, Tensor indices, Any kernel_size, Any stride, Any padding, Any output_size=None) -> Tensor")
