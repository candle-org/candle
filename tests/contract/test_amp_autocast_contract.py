...
def test_autocast_clears_cache_on_outer_exit(monkeypatch):
    from candle.amp import autocast
    from candle.amp import autocast_mode
...
def _define_identity_custom_op():
    import uuid
    import candle.library as library
...
def test_set_autocast_enabled_accepts_single_arg_like_torch():
    from candle.amp import state as amp_state
