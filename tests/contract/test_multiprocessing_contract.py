...
def test_candle_multiprocessing_module_exists_and_exports_context_api():
...
def test_candle_multiprocessing_start_methods_match_python():
    import candle.multiprocessing as mt_mp

    assert set(mt_mp.get_all_start_methods()) == set(py_mp.get_all_start_methods())


def test_dataloader_default_context_uses_candle_multiprocessing_module():
